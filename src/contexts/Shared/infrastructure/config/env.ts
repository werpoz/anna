...
export const env = {
  ...
  corsOrigins: listOrDefault(process.env.CORS_ORIGINS, ['http://localhost:3000', 'http://localhost:3001']),
  ...
  authCookieSameSite: sameSiteOrDefault(process.env.AUTH_COOKIE_SAMESITE, 'Lax'),
  ...
  eventsStreamMaxLen: numberOrDefault(process.env.EVENTS_STREAM_MAX_LEN, 100000),
  ...
  sessionsCommandStreamMaxLen: numberOrDefault(process.env.SESSIONS_COMMAND_STREAM_MAX_LEN, 100000),
